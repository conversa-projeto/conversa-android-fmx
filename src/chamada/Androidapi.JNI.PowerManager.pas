...
type
  ...
  JPowerManagerClass = interface(JObjectClass)
    ...
    function _GetPROXIMITY_SCREEN_OFF_WAKE_LOCK: Integer;
    { Properties }
    ...
    property PROXIMITY_SCREEN_OFF_WAKE_LOCK: Integer read _GetPROXIMITY_SCREEN_OFF_WAKE_LOCK;
  end;
...
begin
  ...
  begin
    ...
    AWakeLock := PowerManager.newWakeLock
      (TJPowerManager.JavaClass.PROXIMITY_SCREEN_OFF_WAKE_LOCK,
